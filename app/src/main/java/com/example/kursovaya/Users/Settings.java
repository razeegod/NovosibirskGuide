...
public class Settings extends AppCompatActivity {
    ...
    private void updateEmail() {
        ...
        mAuth.getCurrentUser().updateEmail(InputEmail.getText().toString())
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Log.d("User email update", "Email updated");
                        } else {
                            Log.d("User email update", "Failed to update email");
                        }
                    }
                });
    }
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if(task.isSuccessful())
                    {
                        ...
                        startActivity(new Intent(Settings.this, Profile.class));
                        Toast.makeText(Settings.this, "Данные успешно изменены", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    else
                    {
