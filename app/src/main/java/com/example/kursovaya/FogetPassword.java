...
public class FogetPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    auth.sendPasswordResetEmail(UserEmail.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Intent succesIntent = new Intent(FogetPassword.this, Login.class);
        ...
        BackBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backIntent = new Intent(FogetPassword.this, Login.class);
    ...
    private void init()
    {
        ...
        UserEmail = findViewById(R.id.input_email_reset);
